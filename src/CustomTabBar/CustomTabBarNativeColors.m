...
UIColor *CustomTabBarCardBackgroundColor(void) {
    return Resolve(TwitterColors(), @selector(subscriptionMarketingFeatureCardBackgroundColor), [UIColor systemBackgroundColor]);
}

UIColor *CustomTabBarInactiveCardBackgroundColor(void) {
    return Resolve(TwitterColors(), @selector(tabCustomizationInactiveGridCellContainerBackgroundColor), [UIColor secondarySystemBackgroundColor]);
}

UIColor *CustomTabBarCardShadowColor(void) {
    return Resolve(TwitterColors(), @selector(subscriptionMarketingFeatureCardShadowColor), [UIColor blackColor]);
}
...
UIColor *CustomTabBarIconColor(void) {
    return Resolve(objc_getClass("T1TabView"), @selector(itemColor), [UIColor labelColor]);
}
...
UIColor *CustomTabBarScreenBackgroundColor(void) {
    return Resolve(TwitterColors(), @selector(backgroundColor), [UIColor systemBackgroundColor]);
}

UIColor *CustomTabBarSeparatorColor(void) {
    return Resolve(TwitterColors(), @selector(navigationBarShadowColor), [UIColor separatorColor]);
}
