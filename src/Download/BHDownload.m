...
static NSString *BHTSanitizedDownloadFileName(NSURL *url) {
...
@interface BHDownload () <NSURLSessionDownloadDelegate>
...
- (void)downloadFileWithURL:(NSURL *)url {
    ...
    self.fileName = BHTSanitizedDownloadFileName(url);
...
- (void)notifyFailure:(NSError *)error {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        id<BHDownloadDelegate> delegate = weakSelf.delegate;
